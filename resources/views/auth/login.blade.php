...
<head>
    ...
    <meta name="description" content="Sign in to ChamaHub — Manage your Chama savings and loans.">
    <title>ChamaHub — Sign In</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .fc-3 { top: 60%; left: 2%; animation: floatY 11s ease-in-out infinite; display: none; }
    ...
    <div class="auth-wrapper">
        ...
        <div class="auth-card">
            ...
            <div class="auth-footer">
                ...
                <a href="{{ route('register') }}">Create a new Chama account</a>
            </div>
        </div>
