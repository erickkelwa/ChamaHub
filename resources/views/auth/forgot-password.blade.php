...
<head>
    ...
    <meta name="description" content="Reset your ChamaHub password — we'll send you a reset link.">
    <title>ChamaHub — Forgot Password</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .fc-1 { top: 12%; left: 4%; animation: floatY 7s ease-in-out infinite; }
        .fc-2 { bottom: 18%; right: 3%; animation: floatY 9s ease-in-out infinite reverse; }
        ...
        .icon-circle {
            ...
            background: linear-gradient(135deg, rgba(99,102,241,0.35), rgba(167,139,250,0.35));
        ...
        .status-alert i { font-size: 1.1rem; flex-shrink: 0; }
...
<body>
    ...
    <div class="auth-wrapper">
        ...
        <div class="auth-card">
            ...
            <h1 class="auth-card-title">Forgot your password?</h1>
